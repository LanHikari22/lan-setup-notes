...
Following [github: Installing PipreWire](https://github.com/NelloKudo/osu-winello/wiki/Installing-PipeWire) [^2](Wk%2027%20000%20Setting%20up%20Osu.md#2),
...
But in [github: Installing Osu](https://github.com/NelloKudo/osu-winello?tab=readme-ov-file) [^1](Wk%2027%20000%20Setting%20up%20Osu.md#1),
...
In [4.1 Downloaded songs cannot be played](Wk%2027%20000%20Setting%20up%20Osu.md#4-1-downloaded-songs-cannot-be-played) we learned that we can download templates from artists, but those are not mapped and cannot be played and are made for editing. Let's delete those.
