...
Let's go with [github: pixie_wrangler](https://github.com/rparrett/pixie_wrangler) [^5](Wk%2026%20000%20On%20why%20the%20rust%20linker%20is%20single-threaded.md#5)! This is a cool game about PCB design! It works on itch.io but let's try to build it ourselves.
...
We get a confirmation from the documentation. [rustprojectprimer: linking](https://rustprojectprimer.com/building/linker.html) [^7](Wk%2026%20000%20On%20why%20the%20rust%20linker%20is%20single-threaded.md#7) specifies that there exists rust parallel linkers, but normally they are single-threaded. But it would be best to get an operational proof.
...
1. [Rust GameDev WG](https://gamedev.rs/) ^2
1. [itch.io open source rust games](https://itch.io/games/made-with-rust/tag-open-source) ^3
1. [itch.io: pixie_wrangler](https://euclidean-whale.itch.io/pixie-wrangler) ^4
