...
In [esbuild docs](https://esbuild.github.io/getting-started/) [<a name="1" />^1](000%20Making%20Greasemonkey%20scripts.md#1),
...
[Greasemonkey manual](https://wiki.greasespot.net/Greasemonkey_Manual) [<a name="2" />^2](000%20Making%20Greasemonkey%20scripts.md#2).
...
1. [greasemonkey manual](https://wiki.greasespot.net/Greasemonkey_Manual) ^2
